...
<html>
    ...
    <body>
        <div class="container">
            ...
            <form method="post" name="formularioactualizar"  action="ActuUsu.jsp">
                    ...
                    <%
                        ...
                        try{
                            ...
                            try{
                                ...
                                String q = "select id_usu, nom_usu , apellidop, apellidom, edad_usu, tel_usu, email_usu, nom_id, pass_usu from usu "
                                        + "where id_usu="+id;
                        ...
                        <tr>
                            <td>Email:</td>
                            <td> <input type="text" name="email" value="<%=rs.getString("email_usu")%>" > </td>
                        </tr>  
                        <tr>
                            <td>Nombre ID:</td>

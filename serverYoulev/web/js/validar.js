function validar(formulario){
    ...
    if(formulario.repeticiones.value.length < 3){
        alert("Escriba por lo menos 3 caracteres dentro del campo de repeticiones");
        formulario.repeticiones.focus();
        return false;
    }
    if(formulario.repeticiones.value.length > 20){
        alert("Escriba menos de 20 caracteres dentro del campo de repeticiones");
        formulario.repeticiones.focus();
        return false;
    }
    ...
    var checkStr = formulario.repeticiones.value;
    ...
    if(!allvalid){
       alert("Escribe solo letras en el campo repeticiones");
       formulario.repeticiones.focus();
       return false;
    }
    var checkOK = "QWERTYUIOPASDFGHJKLÑZXCVBNM" 
